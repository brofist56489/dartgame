...
"^":"",
Iq:function(){var z=document.querySelector("#GAME_CANVAS")
$.b1=z
if(z!=null)$.OQ=J.PB(z,"2d")
z=$.b1
$.UN=800
J.vP(z,800)
z=$.b1
...
J.OE(z,600)
A.UQ("blue")
A.iy(100,200,50,40,"red")
return},
UQ:function(a){var z=$.OQ
if(z==null)return
J.yc(z,a)
J.HM($.OQ,0,0,$.UN,$.Tu)},
iy:function(a,b,c,d,e){var z=$.OQ
if(z==null)return
J.yc(z,e)
J.HM($.OQ,a,b,c,d)}},1],["","",,H,{
"^":"",
...
else if(z.n(c,4))return new H.Qx(a,d,e,f,g).$0()
...
static:{N:function(a,b,c){return new P.bJ(null,null,!0,a,b,"Value not in range")}}},
ds:{
"^":"Ge;G1",
...
try{if(w===y){$[c]=x
try{w=$[c]=e()}finally{if(w===y)$[c]=null}}else{if(w===x)H.eQ(b)}return w}finally{$[d]=function(){return this[c]}}}}
...
if(typeof dartMainRunner==="function"){dartMainRunner(A.Iq,[])}else{A.Iq([])}})
})()
